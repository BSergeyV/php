...
function getRandomAnswer() {
    ...
    let questionPhrase = [
        ...
        `Мне кажется, что вы задумали число${getTextOfNumber(answerNumber)}?`,
        `Неужели это число${getTextOfNumber(answerNumber)}?`,
        `Это просто! Вы задумали число${getTextOfNumber(answerNumber)}?`,
        ];
